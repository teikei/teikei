...
export async function createDepot(createDepotParams: CreateDepotParams) {
  return getClient()
    .service('depots')
    .create(mapDepotToApiParams(createDepotParams))
}
...
export async function updateInitiative(
  ...
  return getClient().service('initiatives').patch(id, updateInitiativeParams)
}
...
export async function createInitiative(
  ...
  return getClient().service('initiatives').create(createInitiativeParams)
}
