...
Component `.docs.md` files and the `routes/__design` catalog document current
usage. Storybook can be added later to make these rules more visible through
interactive examples, controls, and variant matrices.
