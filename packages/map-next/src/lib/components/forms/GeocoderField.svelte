	...
	<InputGroup.Root>
		...
		{#if showSuggestions}
			<div
				...
				class="absolute top-full right-0 left-0 z-[var(--z-map-overlay)] mt-1 overflow-hidden rounded-3xl bg-popover text-popover-foreground shadow-lg ring-1 ring-foreground/5"
			>
				{#if isLoading}
