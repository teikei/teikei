class Place < ActiveRecord::Base
  ...
  has_and_belongs_to_many :places, association_foreign_key: :place_b_id, join_table: 'place_connections', class_name: 'Place'
  has_and_belongs_to_many :reverse_places, association_foreign_key: :place_a_id, join_table: 'place_connections', class_name: 'Place'
